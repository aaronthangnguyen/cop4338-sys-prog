...
static char DEFAULT_PROGRAM_NAME[] = "passgenerator";
#define NUM_TEST_CASES 3
static char* TESTCASES[] = {""//TC#1
								  , ""//TC#2
								  ,""//TC#3
								  };
static const char**  TEST_ARGS[] = {"-p",  "2", "-c", "2", "-f", "dict.txt", "-n", "10", "-l", "4", "",//TC#1
							  "-p",  "4", "-c", "4", "-f", "dict.txt", "-n", "12", "-l", "4", "",//TC#2
							  "-p",  "2", "-c", "2", "-f", "dict.txt", "-n", "10", "-l", "6", ""//TC#3
							 };	
